...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->string('two_factor_method', 30)->nullable();
    ...
    // Add PostGIS geography column for location (longitude, latitude) and GIST index.
    // Use raw statements for compatibility across setups.
